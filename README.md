...
|[cadoodle](https://cadoodlecad.com/)|0.47.002|A drag-and-drop CAD package for beginners.
...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en/)|2026-08-02|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
...
|[espeak-ng-nightly](https://github.com/espeak-ng/espeak-ng)|30719074513|
...
|[fnox](https://fnox.jdx.dev/)|1.32.0|encrypted/remote secret manager
...
|[llamafile](https://github.com/Mozilla-Ocho/llamafile)|0.10.4|Distribute and run LLMs with a single file.
...
|[ovrley](https://www.ovrley.cc/)|2.25.7|Build telemetry overlay for videos from GPX, FIT and SRT activity data
|[paulstretch](https://hypermammut.sourceforge.net/paulstretch/)|2.2.2|Paul's Extreme Sound Stretch
|[podsync-nightly](https://github.com/mxpv/podsync)|2026-07-30|Turn YouTube or Vimeo channels, users, or playlists into podcast feeds - nightly build
...
|[whisperfile](https://docs.mozilla.ai/llamafile/whisperfile/index)|0.10.4|Single-file speech-to-text tool built on whisper.cpp and Cosmopolitan Libc
...
| Name | Description | Version |
|------|-------------|---------|
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.1.212|Anthropic's agentic coding tool that lives in your terminal
