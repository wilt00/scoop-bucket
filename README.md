...
|[cadoodle](https://cadoodlecad.com/)|0.46.054|A drag-and-drop CAD package for beginners.
...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en/)|2026-08-18|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
...
|[fnox](https://fnox.jdx.dev/)|1.33.1|encrypted/remote secret manager
...
| Name | Description | Version |
|------|-------------|---------|
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.1.226|Anthropic's agentic coding tool that lives in your terminal
