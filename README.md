...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en/)|2026-07-24|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
...
|[espeak-ng-nightly](https://github.com/espeak-ng/espeak-ng)|29962603611|
...
|[ovrley](https://www.ovrley.cc/)|2.21.7|Build telemetry overlay for videos from GPX, FIT and SRT activity data
...
| Name | Description | Version |
|------|-------------|---------|
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.1.206|Anthropic's agentic coding tool that lives in your terminal
