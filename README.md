...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en/)|2025-09-25|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|1.0.126|Anthropic's agentic coding tool that lives in your terminal
