...
|[cadoodle](https://cadoodlecad.com/)|0.45.12|A drag-and-drop CAD package for beginners.
...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en/)|2026-06-26|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
...
|[podsync-nightly](https://github.com/mxpv/podsync)|2026-06-23|Turn YouTube or Vimeo channels, users, or playlists into podcast feeds - nightly build
...
| Name | Description | Version |
|------|-------------|---------|
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.1.181|Anthropic's agentic coding tool that lives in your terminal
