...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en/)|2026-07-16|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
...
| Name | Description | Version |
|------|-------------|---------|
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.1.204|Anthropic's agentic coding tool that lives in your terminal
