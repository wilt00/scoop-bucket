...
|[cadoodle](https://cadoodlecad.com/)|0.44.4|A drag-and-drop CAD package for beginners.
...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en/)|2026-06-17|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
...
|[dusklight](https://github.com/TwilitRealm/dusklight)|1.4.1|Dusklight is a reverse-engineered reimplementation of Twilight Princess.
...
| Name | Description | Version |
|------|-------------|---------|
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.1.169|Anthropic's agentic coding tool that lives in your terminal
