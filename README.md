...
|[axelchat](https://github.com/3dproger/AxelChat/)|0.45.0|Displays chats from multiple services in one window
...
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.1.1|Anthropic's agentic coding tool that lives in your terminal
