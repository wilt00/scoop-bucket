...
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.1.50|Anthropic's agentic coding tool that lives in your terminal
...
|[driver-store-explorer](https://github.com/lostindark/DriverStoreExplorer)|0.12.145|Driver Store Explorer [RAPR] makes it easier to deal with Windows driver store. Supported operations include list/add/install/delete third-party driver packages.
|[es](https://www.voidtools.com/)|1.1.0.27|Command-line interface for the Everything search tool
|[espeak-ng-nightly](https://github.com/espeak-ng/espeak-ng)|22519396543|
