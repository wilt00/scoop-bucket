...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en/)|2025-09-16|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|1.0.117|Anthropic's agentic coding tool that lives in your terminal
...
|[driver-store-explorer](https://github.com/lostindark/DriverStoreExplorer)|0.12.118|Driver Store Explorer [RAPR] makes it easier to deal with Windows driver store. Supported operations include list/add/install/delete third-party driver packages.
