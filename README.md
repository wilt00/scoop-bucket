...
|[cadoodle](https://cadoodlecad.com)|0.48.005|A drag-and-drop CAD package for beginners.
...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en)|2026-09-25|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
...
|[reblue-nightly](https://github.com/zolaware/reblue)|1.2.1.86|re:Blue rebuilds Blue Dragon (2007) as a native application. Nightly build.
...
|[tic-80-nightly](https://tic80.com)|36043619178|A fantasy computer for making, playing and sharing tiny games. Unstable nightly builds.
...
| Name | Version | Description |
|------|---------|-------------|
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.1.274|Anthropic's agentic coding tool that lives in your terminal.
...
|[maki](https://maki.sh)|0.5.6|DEPRECATED: use main/maki. An AI coding agent optimized for minimal use of context tokens, while providing a great user experience.
