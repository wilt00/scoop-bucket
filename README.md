...
|[axelchat](https://github.com/3dproger/AxelChat/)|0.43.0|Displays chats from multiple services in one window
...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en/)|2025-12-13|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.0.65|Anthropic's agentic coding tool that lives in your terminal
...
|[espeak-ng-nightly](https://github.com/espeak-ng/espeak-ng)|19631104117|
