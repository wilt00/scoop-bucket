...
|[cadoodle](https://cadoodlecad.com/)|0.46.050|A drag-and-drop CAD package for beginners.
...
| Name | Description | Version |
|------|-------------|---------|
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.1.223|Anthropic's agentic coding tool that lives in your terminal
