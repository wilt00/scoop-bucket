...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en)|2026-09-24|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
...
|[reblue-nightly](https://github.com/zolaware/reblue)|1.2.1.84|re:Blue rebuilds Blue Dragon (2007) as a native application. Nightly build.
...
|[tic-80-nightly](https://tic80.com)|35970148024|A fantasy computer for making, playing and sharing tiny games. Unstable nightly builds.
...
| Name | Version | Description |
|------|---------|-------------|
|[claude-code](https://docs.anthropic.com/en/docs/claude-code/overview)|2.1.273|Anthropic's agentic coding tool that lives in your terminal.
