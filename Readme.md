...
|------|-------------|---------|
|[as-cmd](https://github.com/mkckr0/audio-share)|0.3.2|Audio Share command line client; share Windows/Linux audio to Android phone over network
|[audio-share](https://github.com/mkckr0/audio-share)|0.3.2|Audio Share GUI client; share Windows/Linux audio to Android phone over network
...
|[cataclysm-bn-nightly](https://docs.cataclysmbn.org/en/)|2025-02-24|Cataclysm: Bright Nights is a roguelike with sci-fi elements set in a post-apocalyptic world. Fork of Cataclysm: Dark Days Ahead.
...
|[driver-store-explorer](https://github.com/lostindark/DriverStoreExplorer)|0.12.40|Driver Store Explorer [RAPR] makes it easier to deal with Windows driver store. Supported operations include list/add/install/delete third-party driver packages.
|[es](https://www.voidtools.com/)|1.1.0.27|Command-line interface for the Everything search tool
|[espeak-ng-nightly](https://github.com/espeak-ng/espeak-ng)|13070370275|
...
|[llamafile](https://github.com/Mozilla-Ocho/llamafile)|0.9.0|Distribute and run LLMs with a single file.
